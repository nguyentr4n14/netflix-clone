    ...
    return (
        <div className="hero-bg relative">
            ...
            <header className="max-w-6xl mx-auto flex items-center justify-between p-4 pb-10">
                ...
                <Link
                    to={'/login'}
                    className="text-white bg-red-600 py-1 px-2 rounded hover:cursor-pointer hover:bg-red-700 transition-colors duration-300"
                >
                    Sign In
                </Link>
            </header>
            ...
            <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
                ...
                >
                    ...
                    <button className="bg-red-600 text-xl lg:text-2xl font-bold px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center hover:cursor-pointer hover:bg-red-700 transition-colors duration-300">
                        Get Started
